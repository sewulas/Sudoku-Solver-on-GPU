...
# sudoku method count input\_file output\_file
...
# sudoku gpu 10000 sudoku\_input.txt sudoku\_output.txt
...
# \* \*\*input\_file\*\* – file containing Sudoku boards

# \* \*\*output\_file\*\* – file where solutions are written
